...
from .models import Profile, Area, Instrument
...
def profile_update(request):
    if request.method == "POST":
        ...
        profile.save()
        return render(request, 'profile.html', {'worker_number': worker_number, 'instrument_number': instrument_number,
...
def save_instrument(request):
    ...
    # Area.measuringInstrument = request.POST('instrument')
    Area.save()
